...
menu.t_valuename = {
	...
	punish = {
		...
		{itemname = 'hitstun', displayname = motif.training_info.menu_valuename_punish_rec}, -- 2
	...
	buttonjam = {
		...
		{itemname = 'Light Punch', displayname = motif.training_info.menu_valuename_buttonjam_x},
		{itemname = 'Light Kick', displayname = motif.training_info.menu_valuename_buttonjam_a},
		{itemname = 'Strong Punch', displayname = motif.training_info.menu_valuename_buttonjam_y},
		{itemname = 'Strong Kick', displayname = motif.training_info.menu_valuename_buttonjam_b},
		{itemname = 'Launch', displayname = motif.training_info.menu_valuename_buttonjam_c},
		{itemname = 'OH', displayname = motif.training_info.menu_valuename_buttonjam_z},
		{itemname = 'Rev Art', displayname = motif.training_info.menu_valuename_buttonjam_w},
		{itemname = 'Grab', displayname = motif.training_info.menu_valuename_buttonjam_d},
	},
}
