...
local motif =
{
	...
	training_info =
	{
		...
		menu_valuename_punish_off = "None", --PXN Feature
		menu_valuename_punish_guard = "Guard", --PXN Feature
		menu_valuename_punish_rec	= "Hitstun", --PXN Feature
		...
		menu_valuename_buttonjam_x = "L Punch", --Ikemen feature
		menu_valuename_buttonjam_a = "L Kick", --Ikemen feature
		menu_valuename_buttonjam_y = "S Punch", --Ikemen feature
		menu_valuename_buttonjam_b = "S Kick", --Ikemen feature
		menu_valuename_buttonjam_c = "Launch", --Ikemen feature
		menu_valuename_buttonjam_z = "OH", --Ikemen feature
		menu_valuename_buttonjam_w = "Rev Art", --Ikemen feature
		menu_valuename_buttonjam_d = "Grab", --Ikemen feature
	...
	glyphs =
	{
		...
		['^P'] = {7, 0}, --Any Punch (X / Y / Z)
		['^K'] = {8, 0}, --Any Kick (A / B / C)
		['^LP'] = {1, 0}, --Light Punch (X)
		['^SP'] = {3, 0}, --Heavy Punch (Z)
		['^LK'] = {2, 0}, --Light Kick (A)
		['^SK'] = {4, 0}, --Medium Kick (B)
		['^L'] = {5, 0}, --Any Punch (X / Y / Z)
		['^OH'] = {6, 0}, --Any Kick (A / B / C)
		['^2K'] = {11, 0}, --2 Kick (A+B / B+C / A+C)
		['^2P'] = {10, 0}, --2 Punch (X+Y / Y+Z / X+Z)
		...
		['_QFD'] = {105, 0}, --1/4 Circle Forward Down
		['_QDB'] = {104, 0}, --1/4 Circle Down Back (QCB/QDB)
		['_QCB'] = {104, 0}, --1/4 Circle Down Back (QCB/QDB)
		['_QBU'] = {106, 0}, --1/4 Circle Back Up
		['_QUF'] = {107, 0}, --1/4 Circle Up Forward
		['_QBD'] = {108, 0}, --1/4 Circle Back Down
		['_QDF'] = {106, 0}, --1/4 Circle Down Forward (QCF/QDF)
		['_QCF'] = {106, 0}, --1/4 Circle Down Forward (QCF/QDF)
		...
		['_XBB'] = {117, 0}, --2x Back
		['_DSB'] = {118, 0}, --Dragon Screw Forward
		['_DSF'] = {119, 0}, --Dragon Screw Back
		['_AIR'] = {121, 0}, --AIR
		['_TAP'] = {122, 0}, --TAP
		['_MAX'] = {123, 0}, --MAX
		['_EX'] = {124, 0}, --EX
...
function motif.setBaseTrainingInfo()
	...
	motif.training_info.menu_itemname_reset = "Reset"
