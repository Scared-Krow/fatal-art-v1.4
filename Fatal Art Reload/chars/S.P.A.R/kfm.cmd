...
command = ~D, B, D, B, b;~F, D, DF, F, D, DF, y
time = 20
buffer.time = 3
...
trigger1 = ctrl
trigger2 = (stateno = [200,299]) || (stateno = [400,499]) || stateno = 1402 || stateno = 2002 || stateno = 311|| stateno = 2188
...
value = 10078
triggerall = command != "FDF_ab"
triggerall = command = "FDF_b" || command = "FDF_a"
triggerall = statetype !=A
trigger1 = var(1)
trigger2 = stateno = 410 && movehit
;DP + K
...
value = 10078
triggerall = command = "FDF_ab"
triggerall = map(EXDP)>0||power<1000
triggerall = statetype !=A
trigger1 = var(1)
trigger2 = stateno = 410 && movehit
;---------------------------------------------------------------------------
...
triggerall = stateno = [1099,1100] && statetype != A
trigger1 = movecontact
value = 1101
...
triggerall = statetype !=A
triggerall = stateno != [2122, 2188] || stateno != 800
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = 410 && movehit
;---------------------------------------------------------------------------
;QCF+SP
...
;-------------------------------------------------------------------------
;REVERSAL ART
[State -1, W-W-W-W-W WHAT COULD THIS BE??!?]
type = ChangeState
value = 1300
triggerall = command = "blocking"
trigger1 = ctrl
...
type = ChangeState
value = 60
triggerall = Map(Dash) <= 0
triggerall = command = "FF"
triggerall = statetype = A
trigger1 = ctrl
trigger2 = movecontact && var(26) > 0
...
triggerall = stateno != [219,225]
triggerall = stateno != 311
triggerall = stateno != 2002
triggerall = stateno != 2188
triggerall = stateno != 100
triggerall = stateno != [440,441]
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(1)
;---------------------------------------------------------------------------
...
[State -1, OH Finisher]
type = ChangeState
triggerall = ifelse(p2dist X> 0, command = "c", command = "c")
triggerall = stateno = 310 && statetype != A
triggerall = time > 21
trigger1 = time < 35
value = 311
;---------------------------------------------------------------------------
...
[state -1, L Finisher]
type = changestate
triggerall = ifelse(p2dist X> 0, command = "buffer_z", command = "buffer_z")
triggerall = stateno = 310 && statetype != A
triggerall = time > 21
trigger1 = time < 35
value = 312
