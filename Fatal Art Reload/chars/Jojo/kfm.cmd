...
;-| Double Tap |-----------------------------------------------------------
[Command]
name = "b_FF"     ;Required (do not remove)
command = F, F
time = 15
buffer.time = 10
...
[state -1, Roll Jump]
type = changestate
triggerall = Map(QCFSK) <= 1
triggerall = command = "holdup"
triggerall = stateno = 1022 && statetype != A
trigger1 = time<= 30
value = 1024
...
triggerall = stateno = 1024 && statetype != A
trigger1 = animtime = 0
value = 1029
[state -1, Enryu Haibi Follow]
type = changestate
...
trigger1 = movehit
value = 650 ;Use combo condition (above)
;---------------------------------------------------------------------------
...
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = [200,299]) || (stateno = [400,499]) || stateno = 320 || stateno = 1028
...
trigger4 = stateno = 1069 && movehit
trigger5 = stateno = 1000 && movehit
trigger6 = stateno = 5190 && movehit
;---------------------------------------------------------------------------
;Launcher
[State -1, Strong Kung Fu Upper]
type = ChangeState
...
trigger3 = stateno = 1070 && movehit
trigger4 = stateno = 1100 && movehit
trigger5 = stateno = 1069 && movehit
trigger6 = stateno = 1000 && movehit
trigger7 = stateno = 5190 && movehit
;---------------------------------------------------------------------------
;EX Ground Pound
[State -1, Fast Kung Fu Palm]
type = ChangeState
...
triggerall = var(41)<=0
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = 1069 && movehit
trigger3 = stateno = 1000 && movehit
trigger4 = stateno = 5190 && movehit
;===========================================================================
;---------------------------------------------------------------------------
;Run Fwd
[State -1, Run Fwd]
